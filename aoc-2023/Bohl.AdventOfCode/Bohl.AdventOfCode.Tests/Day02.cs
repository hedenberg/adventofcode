...
{
    [Fact]
    public void Day2_PartOne_Example()
    {
        var rows = Example1Input.Rows();

        var sum = Cube.Sum(rows.ToList(), 12, 13, 14);

        sum.Should().Be(8);
    }

    [Fact]
    public void Day2_PartOne_Test()
    {
    ...
    [Fact]
    public void Day2_PartTwo_Example()
    {
        var rows = Example1Input.Rows();

        var sum = Cube.Sum(rows.ToList());

        sum.Should().Be(2286);
    }

    [Fact]
    public void Day2_PartTwo_Test()
    {
        var rows = PuzzleInput.Rows();
    ...
    private const string Example1Input = @"Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green";

    private const string PuzzleInput = @"Game 1: 1 green, 2 red, 6 blue; 4 red, 1 green, 3 blue; 7 blue, 5 green; 6 blue, 2 red, 1 green
