...
{
    [Fact]
    public void Day3_PartOne_Example()
    {
        var rows = Example1Input.Rows();

        var sum = EngineSchematic.Sum(rows);

        sum.Should().Be(4361);
    }

    [Fact]
    public void Day3_PartOne_Test()
    {
        var rows = PuzzleInput.Rows();

        var sum = EngineSchematic.Sum(rows);

        sum.Should().BeGreaterThan(518219);
        sum.Should().Be(522726);
    }

    [Fact]
    public void Day3_PartTwo_Example()
    {
        var rows = Example1Input.Rows();

        var sum = GearCounter.Sum(rows);

        sum.Should().Be(467835);
    }

    [Fact]
    public void Day3_PartTwo_Test()
    {
        var rows = PuzzleInput.Rows();

        var sum = GearCounter.Sum(rows);

        sum.Should().BeLessThan(135571749);
        sum.Should().BeLessThan(196734737);
        sum.Should().BeGreaterThan(42573673);
        sum.Should().Be(81721933);
    }

    private const string Example1Input = @"467..114..
...*......
..35..633.
......#..4
617*......
...
.664.598..";
    ...
    private const string PuzzleInput = @"...........................................751........501...................................890.231...............829..168......143.........
......................................*.........841....*....../................+..311.......................441..........*...........202....
